...
import superfood1 from '../images/superfood-1.jpg'
import superfood2 from '../images/superfood-2.jpg'
import superfood3 from '../images/superfood-3.jpg'
        ...
        <div className="grid lg:grid-cols-2 gap-3">
          <div className="grid grid-cols-2 lg:grid-cols-1 gap-3">
            <figure className="relative w-full h-60">
              <img className="w-full h-full absolute top-0 left-0 object-cover rounded-xl" src={superfood1} alt="/"/>
            </figure>
            <figure className="relative w-full h-60">
              <img className="w-full h-full absolute top-0 left-0 object-cover rounded-xl" src={superfood2} alt="/"/>
            </figure>
          </div>
          <figure className="relative w-full h-72 sm:h-96 lg:h-full">
            <img className="w-full h-full absolute top-0 left-0 object-cover rounded-xl" src={superfood3} alt="/"/>
          </figure>
        </div>
